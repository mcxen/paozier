...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "权重决定三引擎结果的融合排序比例": "Weights control blended ranking across the three indexed engines.",
        "范围": "Scope",
        ...
        "SearchKit + SQLite FTS5 + Tantivy 三引擎 · 支持中英文": "SearchKit + SQLite FTS5 + Tantivy triple engines. Chinese and English supported.",
        "打开文件": "Open File",
        "打开链接": "Open Link",
        "添加到报告": "Add to Report",
