...
class AppSettings: ObservableObject, Codable {
    ...
    @Published var searchEngineWeightTantivy: Double = 0.25
    ...
    enum CodingKeys: String, CodingKey {
        case searchResultLimit, searchEngineWeightSK, searchEngineWeightFTS, searchEngineWeightTantivy
    ...
    required init(from decoder: Decoder) throws {
        ...
        searchEngineWeightTantivy = (try? c.decode(Double.self, forKey: .searchEngineWeightTantivy)) ?? 0.25
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try c.encode(searchEngineWeightTantivy, forKey: .searchEngineWeightTantivy)
    ...
    private func load() {
        ...
        searchEngineWeightTantivy = decoded.searchEngineWeightTantivy
